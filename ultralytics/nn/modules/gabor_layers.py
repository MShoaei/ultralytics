...
class GaborLayer(nn.Module):
    def __init__(self, in_channels, out_channels, kernel_size, stride, kernels=1, orientations=8,
        padding=1, extra_kernels=0, bias1=False, 
        ...
        (y, x) = torch.meshgrid(y_space, x_space, indexing=None)
